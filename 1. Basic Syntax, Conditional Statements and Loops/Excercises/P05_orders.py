...
for order in range(number_of_orders):
    ...
    if price_per_capsule < 0.01 or price_per_capsule > 100.00:
        ...
        coffee_per_day_price = price_per_capsule * days * needed_capsules
        print(f"The price for the coffee is: ${coffee_per_day_price:.2f}")
        total_price += coffee_per_day_price
